...
def natural_sort_key(text: str) -> tuple[tuple[int, Any], ...]:
    """Case-insensitive natural key: name2 sorts before name10."""
...
def profile_number_sort_key(profile: object) -> tuple:
    """Sort globally by the trailing number in an AdsPower profile name."""
...
def profile_matches_search(profile: object, keyword: str) -> bool:
    """AdsPower Manager-style contains search over all available fields."""
